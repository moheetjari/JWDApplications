...
public class DisplayItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DisplayItem</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try{
                ...
                Connection cn=DriverManager.getConnection("jdbc:mysql://localhost/salesDB","root","root");
                  ...
                  out.println("<a href='ItemForm'>Add New Item</a><br><hr>");
                  out.println("<center><table border=1><thead><tr><th>Name</th><th>Qty</th><th>Price</th></tr></thead><tbody>");
