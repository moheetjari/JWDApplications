    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                out.print("<form action='EmployeeAdd' method='post'>");
                out.println("Name :  <input type='text' name='ename'><br>");


                out.println("Store: <select name='storeid'><option value='-1'>Select</option>");
                while (rs.next()) {
              ...
              out.println("</select><br><input type='submit' value='Add Employee'>");
